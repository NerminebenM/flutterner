...
export async function signup(req, res) {
  try {
    ...
    // Otherwise, check if a file URL is provided in the request body
      ...
      // If no image is provided at all, handle accordingly, e.g., set a default image or return an error
      user.image = 'default-image-url'; // Replace with actual URL or remove this line if you want to allow users without images.
    }
