...
app.post('/user/google-signin', async (req, res) => {
  ...
  try {
    ...
    // You can use the payload to create a user in your database if it doesn't exist
    // Or find the user in your database if it does
    // Then, create a JWT token or session for the user and send it back to the Flutter app
