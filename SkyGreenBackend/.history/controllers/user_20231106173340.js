...
export async function updateProfile(req, res) {
  // The uploadMiddleware should be called before this to handle image upload.
  try {
    const userId = req.params.userId; // assuming you're getting the user's ID from the URL params
    ...
    if (req.file) {
      user.image = `${req.protocol}://${req.get("host")}/img/${
        req.file.filename
      }`;
    }
